...
class AuthTest(TestCase):
    ...
    def test_sign_up_but_usename_exist(self):
        ...
        user = User(username='sign_up_but_usename_exist', email='sign_up_but_usename_exist@test.com', password='111111',
    ...
    def test_sign_up_but_email_exist(self):
        ...
        user = User(username='sign_up_but_email_exist', email='sign_up_but_email_exist@test.com', password='111111',
                    sign_up_time=datetime.now(),
                    last_visit_time=datetime.now())
        db.session.add(user)
        db.session.commit()
    ...
    def test_login_emial_wrong_password(self):
        ...
        self.delete_all_users()
        user = User(username='login_emial_wrong_password', email='login_emial_wrong_password@test.com',
                    password='111111', sign_up_time=datetime.now(),
                    last_visit_time=datetime.now())
        db.session.add(user)
        db.session.commit()
    ...
    def test_login_email_success(self):
        ...
        self.delete_all_users()
        user = User(username='login_emial_right_password', email='login_emial_right_password@test.com',
                    password='111111', sign_up_time=datetime.now(),
                    last_visit_time=datetime.now())
        db.session.add(user)
        db.session.commit()
    ...
    def test_login_usename_success(self):
        ...
        self.delete_all_users()
        user = User(username='login_usename_right_password', email='login_usename_right_password_1@test.com',
                    password='111111', sign_up_time=datetime.now(),
                    last_visit_time=datetime.now())
        db.session.add(user)
        db.session.commit()
